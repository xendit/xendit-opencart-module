            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="POST" enctype="multipart/form-data" id="form-xendit" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="payment_xendit_environment" id="input-xendit-mode" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input
                                    type="password"
                                    name="payment_xendit_live_public_key"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input
                                    type="password"
                                    name="payment_xendit_live_secret_key"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input
                                    type="password"
                                    name="payment_xendit_test_public_key"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input
                                    type="password"
                                    name="payment_xendit_test_secret_key"
